...
// 		relayDatas, err := da.FindCosmosToEvmCallContractApproved(eventEnvelope.Data.(*types.EvmEvent[*contracts.IScalarGatewayContractCallApproved]))
// 		if err != nil {
...
// 		if len(relayDatas) > 0 {
// 			err = da.CreateEvmContractCallApprovedEvent(eventEnvelope.Data.(*types.EvmEvent[*contracts.IScalarGatewayContractCallApproved]))
// 			if err != nil {
...
// 				Event:      eventEnvelope.Data.(*types.EvmEvent[*contracts.IScalarGatewayContractCallApproved]),
...
// 		_, hash, err := da.CreateEvmCallContractEvent(eventEnvelope.Data.(*types.EvmEvent[*contracts.IScalarGatewayContractCall]))
// 		if err != nil {
...
// 			Hash:  hash,
// 			Event: eventEnvelope.Data.(*types.EvmEvent[*contracts.IScalarGatewayContractCall]),
// 		}
// 		evmEvent := types.EventEnvelope{
// 			Component:          "EvmAdapter",
// 			ReceiverClientName: eventEnvelope.SenderClientName,
...
// 		da.CreateEvmExecutedEvent(eventEnvelope.Data.(*types.EvmEvent[*contracts.IScalarGatewayExecuted]))
